...
namespace VYaml.Serialization
{
    public class UnityResolver : IYamlFormatterResolver
    {
        ...
        {
            { typeof(Color), UnityEngineFormatters.ColorFormatter.Instance },
            { typeof(Color?), new StaticNullableFormatter<Color>(UnityEngineFormatters.ColorFormatter.Instance) },
            { typeof(Color32), UnityEngineFormatters.Color32Formatter.Instance },
            { typeof(Color32?), new StaticNullableFormatter<Color32>(UnityEngineFormatters.Color32Formatter.Instance) },
            ...
            { typeof(Quaternion), UnityEngineFormatters.QuaternionFormatter.Instance },
            { typeof(Quaternion?), new StaticNullableFormatter<Quaternion>(UnityEngineFormatters.QuaternionFormatter.Instance) },
...
#if VYAML_UNITY_MATHEMATICS_INTEGRATION
      { typeof(quaternion), UnityMathQuaternionFormatter.Instance },
      {
        typeof(quaternion?),
