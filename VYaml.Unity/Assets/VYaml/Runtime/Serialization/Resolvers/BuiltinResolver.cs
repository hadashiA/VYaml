...
namespace VYaml.Serialization
{
    public class BuiltinResolver : IYamlFormatterResolver
    {
        ...
        public static readonly Dictionary<Type, Type> KnownGenericTypes = new()
        {
            ...
            { typeof(IEnumerable<>), typeof(ListFormatter<>) },
            { typeof(ICollection<>), typeof(ListFormatter<>) },
            { typeof(IReadOnlyCollection<>), typeof(ListFormatter<>) },
            { typeof(IList<>), typeof(ListFormatter<>) },
            { typeof(IReadOnlyList<>), typeof(ListFormatter<>) },
            { typeof(IDictionary<,>), typeof(DictionaryFormatter<,>) },
            { typeof(IReadOnlyDictionary<,>), typeof(DictionaryFormatter<,>) },
            { typeof(ISet<>), typeof(HashSetFormatter<>) },
