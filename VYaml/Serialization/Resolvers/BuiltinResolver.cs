...
namespace VYaml.Serialization
{
    public class BuiltinResolver : IYamlFormatterResolver
    {
        ...
        static readonly Dictionary<Type, object> FormatterMap = new()
        {
            ...
            { typeof(nint), NativeIntFormatter.Instance },
            { typeof(nuint), NativeUIntFormatter.Instance },
            ...
            { typeof(nint?), NullableNativeIntFormatter.Instance },
            { typeof(nuint?), NullableNativeUIntFormatter.Instance },
            ...
            { typeof(YamlNode), YamlNodeFormatter.Instance },
            { typeof(YamlScalarNode), new YamlNodeFormatter.SubtypeFormatter<YamlScalarNode>() },
            { typeof(YamlMappingNode), new YamlNodeFormatter.SubtypeFormatter<YamlMappingNode>() },
            { typeof(YamlSequenceNode), new YamlNodeFormatter.SubtypeFormatter<YamlSequenceNode>() },
        };
